...
#     def __init__(self, in_features=512, out_features=100):  # 默认输入维度为512
#         super(Discrimination, self).__init__()
#         self.fc1 = nn.Linear(in_features, 512)  # 输入维度由参数控制
#         self.bn1 = nn.BatchNorm1d(512)
#         self.fc2 = nn.Linear(512, out_features)  # 输出维度可配置
...
class Discrimination(nn.Module):
    def __init__(self, dim=1024):
        super(Discrimination, self).__init__()
        self.conv1 = conv3x3(dim, 1024, stride=2)
        self.bn1 = nn.BatchNorm2d(1024)
        self.conv2 = conv3x3(1024, 256, stride=2)
        self.bn2 = nn.BatchNorm2d(256)
        self.conv3 = conv3x3(256, 256, stride=2)
